        ...
        <div style="display:none;" class="admin-content ">
            ...
            <div class="content">
                ...
                <form action="create.php" method="post" enctype="multipart/form-data">
                    ...
                    <div>
                        <label>Title</label>
                        <input id="depot" type="text" name="depot" value="<?php echo $depot ?>" class="text-input">
                    </div>
                    <div>
                        <label>Body</label>
                    ...
                    <div >
                        <button id="add" type="submit" name="add-post" class="btn btn-big">Add Post</button>
                    </div>
                </form>
...
<script>
        $(".mapcontainer").on('dblclick', function(e) {
            ...
            var $this = $(this),
                ...
                plotId = 'Depot-' + Math.round(Math.random() * 1000),
                updateOptions = {
                    'newPlots': {
                    },
                };
        ...
        $(function() {
            ...
            setTimeout(function() {
                // Get the data
                $.getJSON("http://localhost/alamera-new/admin/posts/getdata.php", function(data) {
                    // Success
