...
<body>
    ...
    <div class="map">
        ...
        <div style="display: none;" class="admin-content ">
            ...
            <div class="content">
                ...
                <h2 class="page-title">Add CRU</h2>
                ...
                <form action="create.php" method="post" enctype="multipart/form-data">
                    ...
                    <div>
                        <label>Title</label>
                        <input id="depot" type="text" name="depot" value="<?php echo $CRU ?>" class="text-input">
                    </div>
                    <div>
                        <label>Body</label>
                    ...
                    <div >
                        <button id="add" type="submit" name="add-post" class="btn btn-big">Add CRU</button>
                    </div>
                </form>
    ...
    <script>
        ...
        $(function() {
            ...
            setTimeout(function() {
                // Get the data
                $.getJSON("http://localhost/alamera-new/admin/CRU/getdata.php", function(data) {
                    // Success
